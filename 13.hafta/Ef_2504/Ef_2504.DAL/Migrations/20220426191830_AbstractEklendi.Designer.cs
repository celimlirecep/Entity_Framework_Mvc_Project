...
namespace Ef_2504.DAL.Migrations
{
    ...
    [Migration("20220426191830_AbstractEklendi")]
    partial class AbstractEklendi
    {
            ...
            modelBuilder.Entity("Ef_2504.DAL.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTime>("AuthorCreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 26, 22, 18, 28, 983, DateTimeKind.Local).AddTicks(9449));
            ...
            modelBuilder.Entity("Ef_2504.DAL.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTime>("BookCreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 26, 22, 18, 29, 8, DateTimeKind.Local).AddTicks(7386));
